...
3. [Using Timelapse](#using-timelapse)
4. [Training algorithm](#training-algorithm)
5. [Active learning files folder](#active-learning-files-folder)
6. [Long processing times](#long-processing-times)
7. [Designing your own model](#designing-your-own-model)
8. [Citation](#citation)
9. [Contact](#contact)
...
Timelapse is a GUI that allows users to process and label images 
or video. Timelapse also allows users to review image recognition
...
After installation, you need to first create a Timelapse Template
before labelling the photos.
