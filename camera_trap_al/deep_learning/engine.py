...
- Added feature dimensions and embedding architecture
  type to engine
- Changed embedding function so that feature dimension
  is taken from the attribute and not passed into the
  method
"""
...
class Engine():
    """
    Object for training/finetuning embedding model
    """


    def __init__(self, device, model, criterion, optimizer, arch_type, feat_dim):
        ...
        self.arch_type = arch_type # Not used by class but needed for saving model
    ...
    def embedding(self, dataloader, normalize = False):
